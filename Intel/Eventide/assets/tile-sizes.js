...
(function (global) {
  ...
  /* ---- ZAM / LPDDR6X memory modules — a fixed real physical box, the
     ...
     smaller phone-class package):
       ...
       ZAM_MODULE_NM  — Core / Core Ultra / Xeon 500. CALIBRATED so the
         ...
         the flagship's tightly-packed cluster width (~926px). That
         ...
         remainder). 8·w + 7·GAP == 926px  =>  w ≈ 5.82e6 nm.
  ...
  var ZAM_MODULE_NM     = { w: 5815000, h: 5400000 };  // Core ZAM — flagship-calibrated (8 span X9-599HKX cluster)
